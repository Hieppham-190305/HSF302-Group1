...
public class TourController {
    ...
    private final List<Tour> tours = new ArrayList<>(List.of(
            new Tour("t1", "Sapa 3N2D", "Sapa, Vietnam", 429, 4.9,
                    "<h3><span style=\"color: #0f8b5f;\">Khám phá Sapa hùng vĩ</span></h3><p><strong>Sapa 3 Ngày 2 Đêm</strong> mang đến trải nghiệm <em>ngắm mây trên đỉnh Fansipan</em>, tham quan chợ phiên đặc sắc và đi cáp treo xuyên qua thung lũng Mường Hoa.</p><p><span style=\"color: #e67e22;\">★ Điểm nổi bật:</span> Đội ngũ dẫn đường địa phương nhiệt tình, khách sạn 4 sao sang trọng.</p>",
                    "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?auto=format&fit=crop&w=1200&q=80"),
            new Tour("t2", "Da Lat Chill", "Da Lat, Vietnam", 319, 4.8,
                    "<h3><span style=\"color: #2980b9;\">Thành phố ngàn hoa Đà Lạt</span></h3><p>Thả hồn bên những đồi thông lãng mạn, <strong>thưởng thức cà phê cầu đất</strong> và ngắm hoàng hôn rực rỡ bên hồ Xuân Hương.</p><p><em>Không khí se lạnh quanh năm, rất thích hợp để chill và nghỉ dưỡng.</em></p>",
            ...
            new Tour("t3", "Phu Quoc Escape", "Phu Quoc, Vietnam", 559, 4.9,
                    "<h3><span style=\"color: #d35400;\">Thiên đường đảo ngọc Phú Quốc</span></h3><p>Thư giãn tại <strong>Resort 5 sao sát biển</strong>, lặn ngắm san hô và khám phá chợ đêm sầm uất.</p>",
                    "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=1200&q=80"),
            new Tour("t4", "Ha Long Cruise", "Ha Long Bay, Vietnam", 489, 4.7,
                    "<h3><span style=\"color: #8e44ad;\">Du thuyền 5 sao Vịnh Hạ Long</span></h3><p>Trải nghiệm <strong>du thuyền sang trọng</strong>, thăm động Sửng Sốt và chèo thuyền Kayak trên làn nước xanh ngọc bích.</p>",
    ...
    public String checkout(@RequestParam String tourId,
        ...
        flash.addFlashAttribute("checkoutNote", note);
